...
public class MaxTempDate  extends MapReduceBase implements
...
Reducer<Text, IntWritable, Text, IntWritable> {
	...
	public void run(String inputPath, String outputPath) throws Exception {
		JobConf conf = new JobConf(MaxTempDate.class);
		...
		conf.setMapperClass(MaxTempDate.class);
		conf.setReducerClass(MaxTempDate.class);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		try {
			new MaxTempDate().run(args[0], args[1]);
		} catch (Exception e) {
