...
public class MinTempDate  extends MapReduceBase implements
...
Reducer<Text, IntWritable, Text, IntWritable> {
	...
	public void run(String inputPath, String outputPath) throws Exception {
		JobConf conf = new JobConf(MinTempDate.class);
		...
		conf.setMapperClass(MinTempDate.class);
		conf.setReducerClass(MinTempDate.class);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		try {
			new MinTempDate().run(args[0], args[1]);
		} catch (Exception e) {
