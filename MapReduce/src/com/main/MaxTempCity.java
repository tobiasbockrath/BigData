...
public class MaxTempCity  extends MapReduceBase implements
...
Reducer<Text, IntWritable, Text, IntWritable> {
	...
	public void run(String inputPath, String outputPath) throws Exception {
		JobConf conf = new JobConf(MaxTempCity.class);
		...
		conf.setMapperClass(MaxTempCity.class);
		conf.setReducerClass(MaxTempCity.class);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		try {
			new MaxTempCity().run(args[0], args[1]);
		} catch (Exception e) {
